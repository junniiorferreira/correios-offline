 ...
 */
class Correios_Offline_Shipping_PAC_SEDEX extends Correios_Offline_Shipping {
	...
	public function __construct( $instance_id = 0 ) {
		$this->id           = 'correios-offline-pac-sedex';
		$this->method_title = __( 'PAC & SEDEX Offline', 'correios-offline' );
